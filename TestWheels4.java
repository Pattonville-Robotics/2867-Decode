...
@TeleOp(name = "TestWheels4 (Blocks to Java)")
public class TestWheels4 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        left_wheel.setPower(-vert + horz + spin);
        left_wheelback.setPower(vert + (horz - spin));
        right_wheel.setPower(-vert - (horz - spin));
        right_wheelback.setPower(vert - (horz + spin));
        // Put run blocks here.
      }
    }
  }
