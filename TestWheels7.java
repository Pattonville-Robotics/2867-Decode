...
@TeleOp(name = "TestWheels7 (Blocks to Java)")
public class TestWheels7 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        left_wheel.setPower(spin);
        left_wheelback.setPower(-spin);
        right_wheel.setPower(-spin);
        right_wheelback.setPower(spin);
        // Put run blocks here.
      }
    }
  }
