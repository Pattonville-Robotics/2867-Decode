...
@TeleOp(name = "Truecode8 (Blocks to Java)")
public class Truecode8 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        left.setPosition((gamepad1.left_stick_y + 1) / 2);
        right.setPosition(-((gamepad1.left_stick_y + 1) / 2));
        telemetry.update();
      }
    }
  }
